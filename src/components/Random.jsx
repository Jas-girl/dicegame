...
const Random = ({ current, randomFn, resetBtn }) => {
  ...
  return (
    <Section className="section">
      <div className="ran">
        <div className={`dice-image ${isShaking ? 'shake' : ''}`} onClick={handleDiceClick}>
        ...
        <div className="rules">
          ...
          <p>
            After click on dice if selected number is equal to dice number you will get some point as dice if you get guess then 2 points will be deducted
          </p>
        </div>
      </div>
    </Section>
